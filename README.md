...
Сейчас это базовая модель на 350M параметров (`Orpheus-Zero`), обученная в основном на русском игровом лоре / фантастике / текстах песен. В перспективе — мультимодалка (текст + аудио + картинки + видео), но это будущее, не то, что тут сейчас лежит.
